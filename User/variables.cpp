...
//PID pid_pos_205(100, 2.5, 0, 100, 3000, kPitchFeedForward);  //pitch外环
PID pid_pos_205(120, 1.5, 0, 100, 3000, kPitchFeedForward);  //pitch外环
PID pid_vel_205(15, 0, 0, 0, 30000, 0);                    //pitch内环
//PID pid_pos_206(150, 0, 0, 0, 5000, kYawFeedForward);      //yaw外环
PID pid_pos_206(150, 0, 0, 0, 5000, kYawFeedForward);      //yaw外环
PID pid_vel_206(20, 0, 0, 0, 30000, 0);                    //yaw内环
